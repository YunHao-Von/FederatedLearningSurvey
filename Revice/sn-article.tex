...
\begin{figure}[t]
	...
	\includegraphics[width=1.0\linewidth,height=4in]{output/fig1.eps}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=1.0\linewidth,height=3.5in]{output/fig2.eps}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=1.0\linewidth,height=3.5in]{output/fig3.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=3.2in]{output/fig4.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=3.8in]{output/fig5.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=2.8in]{output/fig7.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=2.5in]{output/fig10.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=in]{output/fig11.eps}
...
% Previous malicious detection and suppression
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=3.8in]{output/fig18.eps}
...
Zheng et al.~\cite{zheng2022wmdefense} introduce an anomaly detection algorithm grounded in the Isolation Forest technique for the 
identification of malicious users. This approach serves as a foundational defense mechanism, focusing on 
the detection and exclusion of malicious behaviors through anomaly identification. Subsequently, 
Mehmuda et al.~\cite{mehmuda2023defense} propose a defense method tailored to the federated learning context, utilizing watermarking technology 
to recognize malicious clients. This method bolsters the capability to identify malicious actions,
particularly within federated learning settings. Gong et al.~\cite{gong2023agramplifier} present a more integrated defense 
strategy that enhances the detection of malicious updates by amplifying the characteristics of local updates. 
This strategy not only improves the identification of malicious activities but also addresses the enhancement of 
overall defensive efficiency and model robustness.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth,height=3.5in]{output/fig19.eps}
